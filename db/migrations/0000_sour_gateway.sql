...
ALTER TABLE "tracks" ADD CONSTRAINT "tracks_hopper_member_id_members_id_fk" FOREIGN KEY ("hopper_member_id") REFERENCES "public"."members"("id") ON DELETE set null ON UPDATE no action;